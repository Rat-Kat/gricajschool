...
class Trainings extends \yii\db\ActiveRecord
{
    ...
    public function getComentstraining(){
        return $this->hasMany(Comentstraining::className(),['title_trainings' => 'title']);
    }
    ...
    public function afterSave($insert, $changedAttributes)
   {
    ...
    /**
     * @inheritdoc
     * @return TrainingsQuery the active query used by this AR class.
     */
