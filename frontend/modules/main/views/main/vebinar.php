...
<div class="text-margin">
    ...
    <br>
    <div class="row">
        <?= \yii\bootstrap\Html::img(\yii\helpers\Url::to('@web/uploads/vebinars/'.$model->id.'/'.$model->general_image), ['class'=>'img-responsive col-lg-4 col-md-4 col-sm-5 col-xs-12 img', 'alt'=>'']); ?>
    ...
    <hr>
    <? foreach($model->comentsvebinar as $row): ?>
        <div class="row">
            <div class="col-lg-3">
                <img src="<?=\frontend\components\Common::getImageComentsvebinar($row)[0]?>" class="img-circle" alt="">
            </div>
